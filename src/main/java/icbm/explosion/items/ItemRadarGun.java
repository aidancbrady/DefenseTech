                ...
                if (tileEntity instanceof TileLauncherScreen)
                {
                    ...
                    if (!savedCords.equals(new Pos3D()))
                    {
                        ...
                        if (par3World.isRemote)
                        {
                            ...
                            par2EntityPlayer.addChatMessage(new ChatComponentText(LangUtils.localize("message.radarGun.transfer")));
                        }
                    }
                    else
                    {
                        if (par3World.isRemote)
                            par2EntityPlayer.addChatMessage(new ChatComponentText(LangUtils.localize("message.radarGun.noCoords")));
                    }
                }
