...
public class EntityGrenade extends Entity implements IExplosiveContainer, IEntityAdditionalSpawnData
{
    ...
    public EntityGrenade(World par1World, Pos3D position, int explosiveID)
    {
        this(par1World);
    ...
    {
        if (ExplosiveRegistry.get(this.explosiveID) != null)
        {
            return ExplosiveRegistry.get(this.explosiveID).getGrenadeName();
        }
    ...
    public void onUpdate()
    {
        ...
        {
            ExplosivePreDetonationEvent evt = new ExplosivePreDetonationEvent(this.worldObj, this, ExplosiveType.ITEM, ExplosiveRegistry.get(this.explosiveID));
            ...
            if (evt.isCanceled())
            {
                ...
                EntityItem var13 = new EntityItem(this.worldObj, this.posX + var7, this.posY + var9, this.posZ + var11, new ItemStack(ICBMExplosion.itemGrenade, this.explosiveID, 1));
        ...
        {
            ((Explosive) this.getExplosiveType()).onDetonation(this.worldObj, new Pos3D(this.posX, this.posY + 0.5, this.posZ), this.ticksExisted);
        }
    }
