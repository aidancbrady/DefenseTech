...
public abstract class Explosive implements IExplosive
{
    ...
    {
        return LangUtils.localize("icbm.explosive." + this.nameID + ".name");
    }

    @Override
    public String getGrenadeName()
    {
        return LangUtils.localize("icbm.grenade." + this.nameID + ".name");
    }

    @Override
    public String getMissileName()
    {
        return LangUtils.localize("icbm.missile." + this.nameID + ".name");
    }

    @Override
    public String getMinecartName()
    {
        return LangUtils.localize("icbm.minecart." + this.nameID + ".name");
    }
