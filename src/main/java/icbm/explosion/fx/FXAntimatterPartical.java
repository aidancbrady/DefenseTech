...
public class FXAntimatterPartical extends EntityFX
{
    ...
    public FXAntimatterPartical(World par1World, Pos3D position, double par8, double par10, double par12, double distance)
    {
        this(par1World, position, par8, par10, par12, 1.0F, distance);
    }

    public FXAntimatterPartical(World par1World, Pos3D position, double par8, double par10, double par12, float par14, double distance)
    {
        super(par1World, position.xPos, position.yPos, position.zPos, 0.0D, 0.0D, 0.0D);
