...
public class RenderGrenade extends Render
{
    ...
    public void doRender(Entity entity, double x, double y, double z, float par8, float par9)
    {
        ...
        IIcon icon = ICBMExplosion.itemGrenade.getIconFromDamage(((EntityGrenade) entity).explosiveID);

        GL11.glPushMatrix();
        GL11.glTranslatef((float) x, (float) y + 0.4f, (float) z);
        GL11.glEnable(GL12.GL_RESCALE_NORMAL);
        GL11.glScalef(0.6F, 0.6F, 0.6F);
        RenderUtils.setSpriteTexture(new ItemStack(ICBMExplosion.itemGrenade));
