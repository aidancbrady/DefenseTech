            ...
            if (tileEntity != null)
            {
                if (tileEntity instanceof TileExplosive)
                {
                    ...
                    if (!evt.isCanceled())
                    {
                        ...
                        EntityExplosive eZhaDan = new EntityExplosive(world, new Pos3D(x, y, z).translate(0.5, 0.5, 0.5), ((TileExplosive) tileEntity).haoMa, (byte) world.getBlockMetadata(x, y, z), ((TileExplosive) tileEntity).nbtData);
