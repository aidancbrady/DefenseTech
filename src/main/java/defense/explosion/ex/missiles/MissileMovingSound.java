...
public class MissileMovingSound extends MovingSound
{
    private final EntityMissile field_147670_k;
    private float field_147669_l = 0.0F;

    public MissileMovingSound(EntityMissile p_i45105_1_)
    {
        super(new ResourceLocation(Reference.PREFIX + "missileinair"));
