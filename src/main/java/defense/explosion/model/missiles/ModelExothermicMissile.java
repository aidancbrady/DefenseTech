...
public class ModelExothermicMissile extends ModelMissileBase
{
    // fields
    ...
    public ModelExothermicMissile()
    {
        ...
        Shape1 = new ModelRenderer(this, 98, 92);
        Shape1.addBox(0F, 0F, 0F, 2, 15, 2);
        Shape1.setRotationPoint(-1F, -79F, -1F);
        Shape1.setTextureSize(128, 128);
        Shape1.mirror = true;
        setRotation(Shape1, 0F, 0F, 0F);
        Shape1a = new ModelRenderer(this, 65, 92);
        Shape1a.addBox(0F, 0F, 0F, 1, 14, 6);
        Shape1a.setRotationPoint(2F, -77F, -3F);
        Shape1a.setTextureSize(128, 128);
        Shape1a.mirror = true;
        setRotation(Shape1a, 0F, 0F, -0.1396263F);
        Shape2b = new ModelRenderer(this, 81, 92);
        Shape2b.addBox(0F, 0F, 0F, 6, 14, 1);
        Shape2b.setRotationPoint(-3F, -77F, 2F);
        Shape2b.setTextureSize(128, 128);
        Shape2b.mirror = true;
        setRotation(Shape2b, 0.1396263F, 0F, 0F);
        Shape1c = new ModelRenderer(this, 65, 92);
        Shape1c.addBox(0F, 0F, 0F, 1, 14, 6);
        Shape1c.setRotationPoint(-3F, -77F, -3F);
        Shape1c.setTextureSize(128, 128);
        Shape1c.mirror = true;
        setRotation(Shape1c, 0F, 0F, 0.1396263F);
        Shape1d = new ModelRenderer(this, 81, 92);
        Shape1d.addBox(0F, 0F, 0F, 6, 14, 1);
        Shape1d.setRotationPoint(-3F, -77F, -3F);
        Shape1d.setTextureSize(128, 128);
        Shape1d.mirror = true;
        setRotation(Shape1d, -0.1396263F, 0F, 0F);
    }
